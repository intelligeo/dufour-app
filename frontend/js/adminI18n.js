...
const messages = {
    it: {
        ...
        // fleet
        'fleet.sub.devices':         'Dispositivi',
        'fleet.sub.groups':          'Flotte',
        'fleet.sub.projects':        'Assegnazione progetti',
        'fleet.devices.new':         '+ Nuovo dispositivo',
        'fleet.devices.col.name':    'Nome',
        'fleet.devices.col.id':      'Identificatore',
        'fleet.devices.col.group':   'Flotta',
        'fleet.devices.col.status':  'Stato',
        'fleet.devices.col.last':    'Ultimo aggiornamento',
        'fleet.devices.col.actions': 'Azioni',
        'fleet.devices.edit':        'Modifica',
        'fleet.devices.delete':      '🗑 Elimina',
        'fleet.devices.confirm':     'Eliminare il dispositivo "{name}"?',
        'fleet.groups.new':          '+ Nuova flotta',
        'fleet.groups.col.name':     'Nome',
        'fleet.groups.col.actions':  'Azioni',
        'fleet.groups.edit':         'Modifica',
        'fleet.groups.delete':       '🗑 Elimina',
        'fleet.groups.confirm':      'Eliminare la flotta "{name}"?',
        'fleet.projects.desc':       'Collega dispositivi o flotte Traccar ai progetti per filtrare le posizioni visibili sulla mappa.',
        'fleet.projects.select':     'Seleziona progetto…',
        'fleet.projects.add_device': '+ Dispositivo',
        'fleet.projects.add_group':  '+ Flotta',
        'fleet.projects.remove':     '✕',
        'fleet.projects.empty':      'Nessun dispositivo/flotta collegato.',
        'fleet.projects.type.device':'Dispositivo',
        'fleet.projects.type.group': 'Flotta',
        'fleet.modal.device.new':    'Nuovo dispositivo',
        'fleet.modal.device.edit':   'Modifica dispositivo',
        'fleet.modal.device.name':   'Nome',
        'fleet.modal.device.id':     'Identificatore univoco (IMEI / OsmAnd ID)',
        'fleet.modal.device.group':  'Flotta (opzionale)',
        'fleet.modal.device.cat':    'Categoria',
        'fleet.modal.device.phone':  'Telefono',
        'fleet.modal.device.model':  'Modello',
        'fleet.modal.group.new':     'Nuova flotta',
        'fleet.modal.group.edit':    'Modifica flotta',
        'fleet.modal.group.name':    'Nome flotta',
        'fleet.modal.cancel':        'Annulla',
        'fleet.modal.save':          'Salva',
        'fleet.modal.saving':        'Salvataggio…',
        'fleet.chooser.device':      'Dispositivo da aggiungere',
        'fleet.chooser.group':       'Flotta da aggiungere',
        'fleet.chooser.add':         'Aggiungi',
        'fleet.status.online':       '🟢 Online',
        'fleet.status.offline':      '🔴 Offline',
        'fleet.status.unknown':      '⚪ Sconosciuto',
    ...
    en: {
        ...
        // fleet
        'fleet.sub.devices':         'Devices',
        'fleet.sub.groups':          'Fleets',
        'fleet.sub.projects':        'Project assignment',
        'fleet.devices.new':         '+ New device',
        'fleet.devices.col.name':    'Name',
        'fleet.devices.col.id':      'Identifier',
        'fleet.devices.col.group':   'Fleet',
        'fleet.devices.col.status':  'Status',
        'fleet.devices.col.last':    'Last update',
        'fleet.devices.col.actions': 'Actions',
        'fleet.devices.edit':        'Edit',
        'fleet.devices.delete':      '🗑 Delete',
        'fleet.devices.confirm':     'Delete device "{name}"?',
        'fleet.groups.new':          '+ New fleet',
        'fleet.groups.col.name':     'Name',
        'fleet.groups.col.actions':  'Actions',
        'fleet.groups.edit':         'Edit',
        'fleet.groups.delete':       '🗑 Delete',
        'fleet.groups.confirm':      'Delete fleet "{name}"?',
        'fleet.projects.desc':       'Link Traccar devices or fleets to projects to filter positions visible on the map.',
        'fleet.projects.select':     'Select project…',
        'fleet.projects.add_device': '+ Device',
        'fleet.projects.add_group':  '+ Fleet',
        'fleet.projects.remove':     '✕',
        'fleet.projects.empty':      'No device/fleet linked.',
        'fleet.projects.type.device':'Device',
        'fleet.projects.type.group': 'Fleet',
        'fleet.modal.device.new':    'New device',
        'fleet.modal.device.edit':   'Edit device',
        'fleet.modal.device.name':   'Name',
        'fleet.modal.device.id':     'Unique identifier (IMEI / OsmAnd ID)',
        'fleet.modal.device.group':  'Fleet (optional)',
        'fleet.modal.device.cat':    'Category',
        'fleet.modal.device.phone':  'Phone',
        'fleet.modal.device.model':  'Model',
        'fleet.modal.group.new':     'New fleet',
        'fleet.modal.group.edit':    'Edit fleet',
        'fleet.modal.group.name':    'Fleet name',
        'fleet.modal.cancel':        'Cancel',
        'fleet.modal.save':          'Save',
        'fleet.modal.saving':        'Saving…',
        'fleet.chooser.device':      'Device to add',
        'fleet.chooser.group':       'Fleet to add',
        'fleet.chooser.add':         'Add',
        'fleet.status.online':       '🟢 Online',
        'fleet.status.offline':      '🔴 Offline',
        'fleet.status.unknown':      '⚪ Unknown',
    ...
    fr: {
        ...
        // fleet
        'fleet.sub.devices':         'Appareils',
        'fleet.sub.groups':          'Flottes',
        'fleet.sub.projects':        'Affectation aux projets',
        'fleet.devices.new':         '+ Nouvel appareil',
        'fleet.devices.col.name':    'Nom',
        'fleet.devices.col.id':      'Identifiant',
        'fleet.devices.col.group':   'Flotte',
        'fleet.devices.col.status':  'Statut',
        'fleet.devices.col.last':    'Dernière mise à jour',
        'fleet.devices.col.actions': 'Actions',
        'fleet.devices.edit':        'Modifier',
        'fleet.devices.delete':      '🗑 Supprimer',
        'fleet.devices.confirm':     'Supprimer l\'appareil « {name} » ?',
        'fleet.groups.new':          '+ Nouvelle flotte',
        'fleet.groups.col.name':     'Nom',
        'fleet.groups.col.actions':  'Actions',
        'fleet.groups.edit':         'Modifier',
        'fleet.groups.delete':       '🗑 Supprimer',
        'fleet.groups.confirm':      'Supprimer la flotte « {name} » ?',
        'fleet.projects.desc':       'Associez des appareils ou flottes Traccar à des projets pour filtrer les positions visibles sur la carte.',
        'fleet.projects.select':     'Sélectionner un projet…',
        'fleet.projects.add_device': '+ Appareil',
        'fleet.projects.add_group':  '+ Flotte',
        'fleet.projects.remove':     '✕',
        'fleet.projects.empty':      'Aucun appareil/flotte associé.',
        'fleet.projects.type.device':'Appareil',
        'fleet.projects.type.group': 'Flotte',
        'fleet.modal.device.new':    'Nouvel appareil',
        'fleet.modal.device.edit':   'Modifier l\'appareil',
        'fleet.modal.device.name':   'Nom',
        'fleet.modal.device.id':     'Identifiant unique (IMEI / OsmAnd ID)',
        'fleet.modal.device.group':  'Flotte (optionnel)',
        'fleet.modal.device.cat':    'Catégorie',
        'fleet.modal.device.phone':  'Téléphone',
        'fleet.modal.device.model':  'Modèle',
        'fleet.modal.group.new':     'Nouvelle flotte',
        'fleet.modal.group.edit':    'Modifier la flotte',
        'fleet.modal.group.name':    'Nom de la flotte',
        'fleet.modal.cancel':        'Annuler',
        'fleet.modal.save':          'Enregistrer',
        'fleet.modal.saving':        'Enregistrement…',
        'fleet.chooser.device':      'Appareil à ajouter',
        'fleet.chooser.group':       'Flotte à ajouter',
        'fleet.chooser.add':         'Ajouter',
        'fleet.status.online':       '🟢 En ligne',
        'fleet.status.offline':      '🔴 Hors ligne',
        'fleet.status.unknown':      '⚪ Inconnu',
